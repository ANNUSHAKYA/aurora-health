    ...
    <Tabs>
      ...
      <TabList asChild>
        <CustomTabList>
          ...
          <TabTrigger name="hydration" href="/hydration" asChild>
            <TabButton>Water</TabButton>
          </TabTrigger>
          <TabTrigger name="sleep" href="/sleep" asChild>
            <TabButton>Sleep</TabButton>
          </TabTrigger>
