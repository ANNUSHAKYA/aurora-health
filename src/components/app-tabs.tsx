...
export default function AppTabs() {
  ...
  return (
    <NativeTabs
      ...
      <NativeTabs.Trigger name="hydration">
        <NativeTabs.Trigger.Label>Water</NativeTabs.Trigger.Label>
        <NativeTabs.Trigger.Icon
          src={require('@/assets/images/tabIcons/hydration.png')}
          renderingMode="template"
        />
      </NativeTabs.Trigger>
      ...
      <NativeTabs.Trigger name="sleep">
        ...
        <NativeTabs.Trigger.Icon
          src={require('@/assets/images/tabIcons/sleep.png')}
          renderingMode="template"
        />
      </NativeTabs.Trigger>
      ...
      <NativeTabs.Trigger name="companion">
        ...
        <NativeTabs.Trigger.Icon
          src={require('@/assets/images/tabIcons/companion.png')}
          renderingMode="template"
        />
      </NativeTabs.Trigger>
